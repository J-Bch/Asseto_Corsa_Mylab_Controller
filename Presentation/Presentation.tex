...
\begin{frame}    
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \node[anchor=south west,inner sep=0pt] at ($(current page.south west)-(-0.5cm,-1.2cm)$) {
           \tiny{2\textsuperscript{e} année HEPIA ISC}
        };
    \end{tikzpicture}
...
\begin{frame}    
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.3\textwidth]{Images/mylab_wheel.jpg}
    \end{figure}
...
\begin{frame}    
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.3\textwidth]{Images/mylab_dashboard.jpg}
    \end{figure}
